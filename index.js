...
const partidas = [
    { vitorias: 9, derrotas: 5 },
    { vitorias: 20, derrotas: 10 },
    { vitorias: 50, derrotas: 10 },
    { vitorias: 80, derrotas: 10 },
    { vitorias: 90, derrotas: 10 },
    { vitorias: 100, derrotas: 10 },
    { vitorias: 101, derrotas: 10 }
];

for (let i = 0; i < partidas.length; i++) {
    calcularPartidas(partidas[i].vitorias, partidas[i].derrotas);
}
